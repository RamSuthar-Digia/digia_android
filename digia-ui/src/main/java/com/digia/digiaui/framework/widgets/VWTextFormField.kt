...
class VWTextFormField(
    ...
    override fun Render(payload: RenderPayload) {
        ...
        fun onValueChange(newValue: String) {
            ...
            val triggerAction = { props.onChanged?.let { payload.executeAction(it, "onChanged") } }
        ...
        val prefixWidget: @Composable (() -> Unit)? =
                slot("prefix")?.let { prefixNode ->
                    { BoxWithConstraints { prefixNode.ToWidget(payload) } }
                }

        val suffixWidget: @Composable (() -> Unit)? =
                slot("suffix")?.let { suffixNode ->
                    { BoxWithConstraints { suffixNode.ToWidget(payload) } }
                }
